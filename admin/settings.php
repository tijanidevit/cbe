                    ...
                    <div class="col-sm-6">
                         <a href="setup.php">
                            <div class="card-box bg-theme-colored has-flex p-70">
                                <h1 class="text-white text-uppercase text-center">Configuration</h1>
                            </div>
                        </a>
                    </div><!-- end col -->
                         ...
                         <a href="faculties.php">
                            <div class="card-box bg-warning has-flex p-70">
                                <h1 class="text-white text-uppercase text-center">
                                    <?php if ($config['school_type'] =='university') {
                                   echo "Faculties";
                                }elseif($config['school_type'] =='polytechnic'){
                                    echo "Schools";
                                }elseif($config['school_type'] =='college'){
                                    echo "College";
                                }else{
                                    echo "Faculties";
                                } ?>                                    
                    ...
                    <div class="col-sm-6">
                         <a href="departments.php">
                            <div class="card-box bg-dark has-flex p-70">
                                <h1 class="text-white text-uppercase text-center">Department</h1>
                            </div>
                        </a>
                    </div><!-- end col -->
