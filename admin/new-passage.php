...
if (($adminQuery->rowCount()) == 0) {
    ...
    <head>
        <meta charset="utf-8" />
        <title>Passages  - <?php echo $config['school_name']; ?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">New passage</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <div class="card-box">
                            ...
                            <h4 class="header-title mt-0 mb-4">New passage</h4>
                            <!-- <p class="text-muted font-13">
                                Use a <code>
                                &lt;select multiple /&gt;</code>
                                as your input element for a tags input, to gain true multivalue support.
                            </p> -->
                            <form method="post" action="actions/submit-passage.php"  enctype="multipart/form-data">
                                <div class="row">


                                    <div class="form-group col-12 col-xs-12">
                                        <label class="label">Passage</label> <br/>
                                        <textarea rows="10" name="passage" class="form-control" placeholder="" required="required"></textarea>

                                    </div> 

                                    <div class="form-group col-12 col-xs-12">
                                        <label class="label">Instruction</label> <br/>
                                        <textarea rows="5" name="instruction" class="form-control" placeholder="" required="required"></textarea>
                                ...
                                <div class="">
                                    <button type="submit" class="btn bg-theme-colored btn-md" name="submit-passage">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
